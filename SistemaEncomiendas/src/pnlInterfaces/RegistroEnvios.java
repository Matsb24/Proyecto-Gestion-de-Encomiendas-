...
import ClasesModeloDAO.CategoriaDAO;
...
import ClasesModeloDAO.PagoDAO;
import ClasesModeloDAO.RepartidorDAO;
import ClasesModeloDAO.UbigeoDAO;
...
import OrdenarDatos.OrdenaClie;
import OrdenarDatos.OrdenaEnco;
import OrdenarDatos.OrdenaRepa;
...
public class RegistroEnvios extends javax.swing.JPanel {
    ...
    public RegistroEnvios() {
        initComponents();
        ordCli = new OrdenarDatos.OrdenaClie();
        tblClientes.setModel(tablaClientes);
        ordrep = new OrdenarDatos.OrdenaRepa();
        tblMotori.setModel(tablaRepartidor);
        ordEnc = new OrdenarDatos.OrdenaEnco();
